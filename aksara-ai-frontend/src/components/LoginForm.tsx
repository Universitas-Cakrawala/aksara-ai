...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors">
      <Card className="w-full max-w-md mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800">
        <CardHeader className="space-y-1 relative">
          {/* Dark mode toggle kanan atas */}
          ...
          <CardDescription className="text-center text-muted-foreground">
            Masukkan username dan password Anda atau gunakan login sosial
          </CardDescription>
        </CardHeader>
